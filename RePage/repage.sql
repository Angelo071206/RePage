...
--
-- Host: 127.0.0.1
-- Creato il: Mag 15, 2025 alle 11:52
...
INSERT INTO `libro` (`ID_Libro`, `Titolo`, `Autore`, `ISBN`, `Materia`, `Condizione`, `Descrizione`, `immagine`, `ID_Utente`) VALUES
(28, 'harry', 'angelo', '1234567890ewty', NULL, 'Nuovo', 'yttytr', 'libro_6805215a3c0cd.jpg', 16),
(30, 'harry potter', 'kkkò', 'm .à', NULL, 'Accettabile', 'jkjkòl', 'libro_680555eddc6f4.jpg', 16);
...
--
ALTER TABLE `messaggio`
  MODIFY `ID_Messaggio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
